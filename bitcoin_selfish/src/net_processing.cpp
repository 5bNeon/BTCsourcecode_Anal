...
private:
    ...
    void ProcessBlock(CNode& node, std::shared_ptr<CBlock>& block, bool force_processing);
...
void PeerManagerImpl::ProcessBlock(CNode& node, std::shared_ptr<CBlock>& block, bool force_processing)
{
    bool new_block{false};
    m_chainman.ProcessHonBlock(block, force_processing, &new_block);
    if (new_block) {
